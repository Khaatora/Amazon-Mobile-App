...
class AddressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainCubit, MainState>(
      buildWhen: (previous, current) => current.user.address != previous.user.address,
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                  child: Padding(
                    ...
                    child: BlocBuilder<MainCubit, MainState>(
                      ...
                      builder: (context, state) {
                        return Text(
                          "Delivery to ${state.user.name} - ${state.user
                              .address}",
              ...
              const Padding(
                padding: EdgeInsets.only(right: 5, top: 2), child: Icon(
